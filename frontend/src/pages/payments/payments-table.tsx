...
const PaymentsTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    {label: 'Status', title: 'status', type: 'enum', options: ['Completed','Pending','Refunded']},
  ]);
    const addFilter = () => {
        const newItem = {
            id: uniqueId(),
    ...
    const getPaymentsCSV = async () => {
        const response = await axios({url: '/payments?filetype=csv', method: 'GET',responseType: 'blob'});
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/payments/payments-new'} color='info' label='New Item' />
