...
const CustomersTablesPage = () => {
  ...
  const [filters] = useState([{label: 'FullName', title: 'full_name'},{label: 'Email', title: 'email'},
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title="Customers" main>
        {''}
        ...
        <CardBox   className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <BaseButton
              ...
              onClick={addFilter}
          />
          <BaseButton className={'mr-3'} color='info' label='Download CSV' onClick={getCustomersCSV} />
            <BaseButton
              color='info'
              label='Upload CSV'
